...
*   **📄 Native File Support**: Automatically parses and indexes **CSV** (product data, logs) and **TXT** files.
...
> *Note: Indexing throughput is ~56 docs/sec on CPU, which is optimized for personal/SMB use cases rather than massive-scale ingestion.*
